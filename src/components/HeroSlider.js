    ...
    <section id="home">
      <div className="container">
        ...
        <div className="fn_cs_desc">
          <p>
            VndalTools Website ini dibuat oleh pengembang -VNDAL yang berniat membantu korban Judi Online yang sudah bersusah payah dan berkali kali bermain slot tetapi selalu rungkad dan mengalami kekalahan, Kami hadir membantu kalian semua mencapai kemenangan tanpa imbalan apapun.
          </p>
          <a
